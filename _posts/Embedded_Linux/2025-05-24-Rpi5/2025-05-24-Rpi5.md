...
typora-root-url: ../
post_img_url: /images/2025-05-24-Rpi5
---
...
![Raspberry Pi Imager]({{ page.post_img_url }}/image-1.png)
...
![기존 네트워크 어댑터 설정 변경]({{ page.post_img_url }}/image-2.png)

### 2) Raspberry Pi 어댑터 설정

![라즈베리파이 네트워크 어댑터 설정 변경]({{ page.post_img_url }}/image-3.png)
...
![Advanced IP Scanner]({{ page.post_img_url }}/image.png)
